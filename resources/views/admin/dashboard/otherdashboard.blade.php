...
<!-- red background end -->
       ...
       <td style="text-align:right;">
           ...
           <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('fd5Form.show',$allStatusData->form_no_five_status_id) }}';">দেখুন</button>
           @else
           <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('fd5Form.show',$allStatusData->form_no_five_status_id) }}';">দেখুন</button>
           @endif
